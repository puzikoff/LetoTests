...
public class HowToUseCardScreen extends AppScreenBase{
	...
	public void verify() {
		...
		Log.info("How to use card text:  " + findElement(howToUseCard, driver).getText());
		verify.assertEquals(findElement(howToUseCard, driver).getText(), howToUseCardText, "How to use card text");
		verify.assertAll();
	}
